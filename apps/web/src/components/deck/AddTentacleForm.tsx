                ...
                return (
                  ...
                  >
                    ...
                    <span className="deck-add-form-skill-copy">
                      <span className="deck-add-form-skill-name">
                        {skill.name}
                        {skill.source === "bundled" && (
                          <span className="deck-add-form-skill-badge">bundled</span>
                        )}
                      </span>
                      {skill.description && (
                      ...
                      {skill.missingEnv && skill.missingEnv.length > 0 && (
                        <span className="deck-add-form-skill-warning">
                          Needs {skill.missingEnv.join(", ")} in .env
                        </span>
                      )}
                    </span>
                  </label>
